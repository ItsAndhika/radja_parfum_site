...
const Hero = () => {
	return (
		<section className="pt-28 text-xl font-bold text-white mb-20 sm:pt-36 2xl:pt-72">
			<div className="container flex flex-col justify-center items-center mx-auto px-10 md:px-5 md:justify-between lg:px-10">
				...
				<div className="mx-auto flex flex-col justify-center items-center md:flex-row-reverse md:gap-10 lg:gap-32">
					<HeroImage />
					<div className="flex flex-col justify-start items-center md:items-start">
						...
						<Link
							to="/products"
							className="text-black text-base font-normal bg-primary px-4 py-2 rounded-full transition-primary shadow-md shadow-secondary hover:translate-y-1 hover:shadow-none 2xl:px-6 2xl:py-4 2xl:text-lg"
						>
							Cobain Sekarang
						</Link>
					</div>
